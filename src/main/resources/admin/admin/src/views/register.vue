  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">物流管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">寄件人姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jijianrenxingming" class="input" type="text" placeholder="寄件人姓名">
			   </div>
			 </div> -->
			<el-form-item label="寄件人姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jijianrenxingming" autocomplete="off" placeholder="寄件人姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送员工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongyuangonghao" class="input" type="text" placeholder="配送员工号">
			   </div>
			 </div> -->
			<el-form-item label="配送员工号" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongyuangonghao" autocomplete="off" placeholder="配送员工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">配送员姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.peisongyuanxingming" class="input" type="text" placeholder="配送员姓名">
			   </div>
			 </div> -->
			<el-form-item label="配送员姓名" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.peisongyuanxingming" autocomplete="off" placeholder="配送员姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='peisongyuan'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='peisongyuan'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='peisongyuan'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.peisongyuangonghao) && `peisongyuan` == this.tableName){
        this.$message.error(`配送员工号不能为空`);
        return
      }
      ...
      if(`peisongyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`peisongyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210105/96872527f0e64b618a12213b7af43a25.jpg");
		height: 100vh;
